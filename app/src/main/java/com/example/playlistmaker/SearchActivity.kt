...
class SearchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mockTracksArray: ArrayList<Track> = arrayListOf(
            Track(
                "Очень длинное название трэка. Настолько длинное, что не должно уместиться в одной строке. Интересно, как оно будет отображаться?",
                "Guns N' Roses",
                "5:03",
            ...
            Track(
                "Очень длинное название трэка. Настолько длинное, что не должно уместиться в одной строке. Интересно, как оно будет отображаться?",
                "Очень длинное название исполнителя. что не должно уместиться в одной строке. Интересно, как оно будет отображаться?",
                "5:03",
                "https://is5-ssl.mzstatic.com/image/thumb/Music125/v4/a0/4d/c4/a04dc484-03cc-02aa-fa82-5334fcb4bc16/18UMGIM24878.rgb.jpg/100x100bb.jpg"
            ),
            Track(
        ...
        val tracksAdapter = TracksAdapter(mockTracksArray)
